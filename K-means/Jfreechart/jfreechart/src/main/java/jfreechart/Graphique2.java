...
public class Graphique2 extends JPanel {
	...
	/*tableau de taux d'erreur*/
	public List<Float> donnees ;
 ...
 @param legende : vrai si on affiche la légende
	*/
	...
	public Graphique2(String titre, String abscisse, String ordonnee, List<Float> valeurs, Color fond, List<String> listeSeries, List<String> listeCategory, boolean legende,List<Float> donnees) {
...
*/
	...
	public static void main(String[] a){
		...
		Graphique2 g = new Graphique2("titre", "x", "y", donnees, Color.white, l2, l1, true,donnees);
		f.add(g);
		f.setVisible(true);
	}
